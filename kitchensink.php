...
<body>
  ...
  <section class="bg-light text-dark p-5 p-lg-0 pt-lg-5 text-center text-sm-start">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between">
        <div>
          <h1>Let's have a <span class="text-warning"> Chat </span> </h1>
          <p class="lead my-4">
            Something outside of a lesson or bug? Let's collaborate.
          </p>
        </div>
        <br>
  </section>
  ...
  <div class="container">
    <form method="POST" action="./includes/feedback.inc.php?form=sink" enctype="application/x-www-form-urlencoded">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="textbox" placeholder="What can we work on?*" name="textbox"> <br>
