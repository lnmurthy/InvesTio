                ...
                <div class="modal-body">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="quiz" id="quiz" data-toggle="buttons">
                      ...
                      <label class="element-animation2 btn btn-sm btn-outline-light"><span class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio" name="q_answer" value="2">Day trading</label>
                      <label class="element-animation3 btn btn-sm btn-outline-light"><span class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio" name="q_answer" value="3">Identifying your personal goals and risks</label>
                      <label class="element-animation4 btn btn-sm btn-outline-light"><span class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio" name="q_answer" value="4">Short selling</label>
                    </div>
                    <div class="modal-header">
