  ...
  <section class="bg-light text-dark p-5 p-lg-0 pt-lg-5 text-center text-sm-start">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between">
        <div>
          <h1>Provide <span class="text-warning"> Lesson </span> Ideas</h1>
          <p class="lead my-4">
            We are focusing on providing financial literacy to the youth. What should we add?
          </p>
        </div>
        <br>
  </section>
  ...
  <div class="container">
    <form method="POST" action="./includes/feedback.inc.php?form=lesson" enctype="application/x-www-form-urlencoded">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="textbox" placeholder="What Lesson Do You Want To See?" name="textbox"> <br>
